    ...
    <div>
        ...
        <div class="container content">
                ...
                <div v-for="info in dealer_informations" :key="info.id" class="pannels col-md-3 col-sm-12">
                    <div class="pannel">
                        <div class="info_title">
                            <h5>
                                <router-link
                                    :to="{name: 'information_detail_en', query: {id: info.id, author: info.nikename?info.nikename:info.name}}">
                        ...
                        <div class="info_content">
                            <h6>{{info.content != null && info.content.length>120 ? info.content.slice(0,120)+'...' :
                            info.content}}</h6>
                        </div>
            ...
            <div v-else-if="!user" class="info_post_content">
                <h5>To edit New Information, please <router-link :to="{name: 'login'}">{{ $t('login') }}</router-link>.
                </h5>
            </div>
        </div>
    </div>

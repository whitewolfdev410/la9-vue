<template>
    <div>
        ...
        <div class="container content">
            ...
            <div class="detail_content">
                <div class="detail_date">
                    ...
                    <b-button v-if="user && user.id == detail_data.user_id"
                        @click="edit_information(detail_data.title, detail_data.content)"
                        v-b-modal.edit_information_modal variant="link">
                ...
                <b-modal hide-footer id="edit_information_modal" ref="edit_information_modal" :title="$t('edit')"
                    size="xl" scrollable>
                    <form @submit.prevent="update_information" method="post">
                        <div class="col-md-12" style="margin-bottom: 10px;">
                            <div class="body-pannel">
                                <b-form-input type="text" v-model="editable_title" required></b-form-input>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="body-pannel">
                                <b-form-textarea type="text" v-model="editable_content" rows="10" required>
                                </b-form-textarea>
                            </div>
                        </div>
        ...
        <!-- Comment section -->
        <CommentSection :sendId="this.info_id" />
    </div>
</template>

    ...
    <div class="body row">
      <form @submit.prevent="contact_submit" method="post" enctype="multipart/form-data">
        <div class="col-md-12 row">
          <div class="col-md-6 col-sm-12">
            <div class="body-pannel">
              <b-form-input type="text" ref="your_name" v-model="name" :placeholder="$t('contact.your_name')" required>
              </b-form-input>
            </div>
          </div>
          <div class="col-md-6 col-sm-12">
            <div class="body-pannel">
              <b-form-input type="email" ref="your_email" v-model="email" :placeholder="$t('contact.your_email')"
        ...
        <div class="col-md-12 row">
          <div class="col-md-6 col-sm-12">
            <div class="body-pannel">
              <b-form-input type="text" ref="phone_number" v-model="phone" :placeholder="$t('contact.phone_number')"
                required></b-form-input>
            </div>
          </div>
          <div class="col-md-6 col-sm-12">
        ...
        <div class="col-md-12 row">
          <div class="col-md-12 col-sm-12">
            <div class="body-pannel">
              <b-form-textarea type="text" ref="message" v-model="message" :placeholder="$t('contact.your_text')"

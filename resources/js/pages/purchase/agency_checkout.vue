        ...
        <div class="container">
            <div class="content">
                <div class="category_level">
                    <h4>{{ $t('category_level') }} <router-link class="change" :to="{ name: $t('dealer.url') }">
                            {{ $t('change') }}</router-link>
                    </h4>
                            ...
                            <div style="padding-left: 20px;">
                                <div class="mb-3 row">
                                    <div class="col-md-12">
                                        ...
                                        <input v-model="applicant_email" class="form-control" type="email"
    ...
    methods: {
        ...
        async dealer_application_send() {
            ...
            var { data } = await axios.post('/api/payment/dealer/checkout/application/send', {
                ...
                order_number: this.$route.query.order_no
            })
            this.loading = false
        }
    },

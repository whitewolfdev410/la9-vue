...
export default {
    ...
    methods: {
        async getInformations(lang) {
            try {
                var new_info_datas = await axios.get('/api/get/new_informations/' + lang + '/' + this.user.role + '/all')
                this.informations = new_info_datas.data
            } catch (error) {
                var new_info_datas = await axios.get('/api/get/new_informations/' + lang + '/' + "notLogin" + '/all')
                this.informations = new_info_datas.data
            }
        },
